...
GAUSSIAN_SMOOTH_FILTER_SIZE = (3, 3) #kích cỡ càng to thì càng mờ
ADAPTIVE_THRESH_BLOCK_SIZE = 19 
ADAPTIVE_THRESH_WEIGHT = 9  

img=cv2.imread(r'E:\NAMHOC\python\img\4.jpg')
cv2.imshow('img', img)
...
#cv2.drawContours(img, contours, 5, (255,255,0),3)
largest = []
area_max = 0
largest_rectangle =None
for cnt in contours:
    peri = cv2.arcLength(cnt, True) #Tính chu vi
    approx = cv2.approxPolyDP(cnt, 0.06 * peri, True) # làm xấp xỉ đa giác, chỉ giữ contour có 4 cạnh
